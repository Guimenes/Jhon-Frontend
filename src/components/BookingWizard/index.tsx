...
import { Calendar, Clock, CheckCircle, ArrowLeft, ArrowRight, Scissors, CalendarCheck, MessageSquare, ShoppingBag } from 'lucide-react';
...
const BookingWizard: React.FC<BookingWizardProps> = ({ onClose, onSuccess, initialService }) => {
  ...
  const steps = [
    ...
    { number: 6, title: 'Ofertas Exclusivas', icon: ShoppingBag }
  ];
  ...
  const handleConfirmBooking = async () => {
    ...
    try {
      ...
      // Mostrar produtos promocionais em vez de fechar
      setCurrentStep(6);
    } catch (error: any) {
        ...
        return (
          <PromotionalProducts 
            ...
            onViewAllProducts={() => {
              ...
              onClose();
              // Exemplo: window.location.href = '/loja';
            }} 
          />
        );
    ...
    <div className="booking-wizard-overlay">
      <div className="booking-wizard">
        ...
        <div className="wizard-footer">
          {currentStep === 6 ? (
            // No passo 6 (produtos promocionais), não mostramos botões aqui
            // Os botões serão exibidos no próprio componente PromotionalProducts
            null
          ) : (
            <>
              <button
